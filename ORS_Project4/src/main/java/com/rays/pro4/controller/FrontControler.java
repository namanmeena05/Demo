...
public class FrontControler implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		if (session.getAttribute("user") == null) {
			...
			System.out.println("else ki dofilter");
	...
	public void init(FilterConfig conf) throws ServletException {
		System.out.println("init front clt");
	}
	 ...
	 */
	public void destroy() {
		System.out.println("destroy front clt");
		 // Clean up resources, close connections, and perform any necessary finalization
	    // This method is called when the filter is removed from service.
	    // It is essential for ensuring that resources are released properly.
	}
